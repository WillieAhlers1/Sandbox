#!/usr/bin/env python3
"""Training script for churn_prediction_new pipeline."""
...
def main():
    ...
    dataset_id = os.getenv("BQ_DATASET_ID", "dsci_churn_prediction_new_main")
    table_id = os.getenv("BQ_TABLE_ID", "churn_prediction_new_features")
    output_path = os.getenv("MODEL_OUTPUT_PATH", "/tmp/churn_prediction_new_model.pkl")
