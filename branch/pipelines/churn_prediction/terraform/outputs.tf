# Terraform outputs for churn_prediction pipeline

output "bigquery_dataset_id" {
  value       = google_bigquery_dataset.churn_prediction_dataset.dataset_id
...
output "artifact_registry_repository" {
  value       = google_artifact_registry_repository.churn_prediction_repo.repository_id
  description = "Artifact Registry repository ID"
}

output "artifact_registry_host" {
  value       = "${var.region}-docker.pkg.dev/${var.project_id}/${google_artifact_registry_repository.churn_prediction_repo.repository_id}"
  description = "Artifact Registry host URL for Docker images"
}

output "docker_image_uri" {
  value       = "${var.region}-docker.pkg.dev/${var.project_id}/${google_artifact_registry_repository.churn_prediction_repo.repository_id}/trainer:latest"
  description = "Full Docker image URI for trainer"
}

output "terraform_state_summary" {
  value = {
    dataset_id              = google_bigquery_dataset.churn_prediction_dataset.dataset_id
    artifact_registry_repo  = google_artifact_registry_repository.churn_prediction_repo.repository_id
